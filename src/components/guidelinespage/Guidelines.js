  ...
  return (
    <>
      <div className=" about container">
        ...
        <p>To participate in Winter of Code NITK 2023, mentees/contributors are required to adhere to the following <a href="https://bit.ly/woc-nitk-mentee-guidelines" target="blank">guidelines</a> for the smooth conduction of the program.</p>
        <h3>Application</h3>
        <p></p>
        <ul>
        ...
        <p>To participate in Winter of Code NITK 2023, participating organizations are required to adhere to the following <a href="https://bit.ly/woc-nitk-mentor-guidelines" target="blank">guidelines</a> for the smooth conduction of the program.</p>
        <h3>Application</h3>
        <p></p>
        <ul>
        ...
        <h2>Mentors</h2>
        <p>To participate in <b>NITK Winter of Code</b> 2023, mentors are required to adhere to the following <a href="https://bit.ly/woc-nitk-mentor-guidelines" target="blank">guidelines</a> for the smooth conduction of the program.</p>
        <h3>Application</h3>
        <p></p>
        <ul>
        ...
        <br/>
        <p><i>The decision taken by the organizing committee of Winter of Code shall be final in any case. The organizing committee of Winter of Code reserves the right to suspend, cancel, or modify the structure of the Program. The organizing committee also reserves the right to modify these Program Rules to reflect any modifications to the Program. Any changes made will be effective immediately upon notice which will be notified through the program page and/or email. Continued participation in the Program after such notice will be deemed acceptance of such changes.</i></p> 
      </div>
    </>
  );
}
