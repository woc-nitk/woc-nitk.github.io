  ...
  return (
    <>
      <div className=" about container">
        ...
        <p>For the first time this year, in 2021, we have opened the NITK Winter of Code program for the students  other than NITK to submit proposals and participate in this program. They will be mentored by the organizations from NITK Surathkal.</p>
        <p>Due to the varied schedules of the mentees within and outside NITK, the participants would be allowed to adjust their objectives and avail for a break of utmost two weeks upon discussion with their project mentors. This break is to be clearly mentioned in the timeline of their project proposals. Please note that the timeline of the program will not be altered, the break is to be adjusted by modifying the objectives.</p>
        ...
        <ul>
          ...
          <li>Understanding how programs like Google Summer of Code work!</li>
